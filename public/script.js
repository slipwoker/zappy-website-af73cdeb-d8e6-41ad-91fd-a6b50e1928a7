    ...
    const validateField = function(input) {
      ...
      if (input.hasAttribute('minlength') && value) {
        ...
        if (value.length < minLength) {
          showError(input, `يجب أن يحتوي على ${minLength} أحرف على الأقل`);
          return false;
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'af73cdeb-d8e6-41ad-91fd-a6b50e1928a7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'af73cdeb-d8e6-41ad-91fd-a6b50e1928a7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'af73cdeb-d8e6-41ad-91fd-a6b50e1928a7';
